    ...
    <div id="templatemo_main">
    	<div id="templatemo_content" class="left">
            ...
            <div class="post-item">
                ...
                <a class="more" href="index.php?c=blog&a=detail&bid=<?=$v['bid']; ?>">评论</a>
			</div>
            <?php endforeach; ?>
            ...
            <div class="templatemo_paging">
                <ul>
                    ...
                    <?php if ($p<=$totalPage): ?>
                    <li><a  href="index.php?c=blog&a=blog&page=<?=$p;?>"><?=$p; ?></a></li>
                    <?php endif; ?>
                    <?php if ($p+1<=$totalPage): ?>
                    <li><a  href="index.php?c=blog&a=blog&page=<?=$p+1;?>"><?=$p+1; ?></a></li>
                    <?php endif; ?>
                    <?php if ($p+2<=$totalPage): ?>
                    <li><a  href="index.php?c=blog&a=blog&page=<?=$p+2;?>"><?=$p+2; ?></a></li>
                    <?php endif; ?>
