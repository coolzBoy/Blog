...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
		...
		<p></p>
		<p>设置我的新头像</p>
		<form action="index.php?c=user&a=deal_touxiang" method="post" enctype="multipart/form-data">
			<input type="hidden" name="u" value="<?=$u['username']; ?>">
			<input type="file" name="touxiang"><br /><br />
			<input style="cursor: pointer;" type="submit" value="保存新头像">
		</form>
			...
			<div class="sidebar_section sidebar_section_bg">
                ...
                <ul class="sidebar_link_list">
					<?php if (!$wen): ?>
               		 你尚未发表任何博客！！！
                	<?php else: ?>
                	<?php foreach ($wen as $v): ?>
                    <a href="index.php?c=blog&a=detail&bid=<?=$v['bid'];?>"><li><?=$v['title']; ?></li></a>
                    <?php endforeach; ?>
                    <?php endif; ?>
